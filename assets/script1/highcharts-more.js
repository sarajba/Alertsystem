...
(function(k, D) {
    ...
    p(A, "getLabelPosition", function(a, b, c, d, e, g, f, j, n) {
        ...
        l.isRadial ? (a = l.getPosition(this.pos, l.center[2] / 2 + r(g.distance, -25)), g.rotation === "auto" ? d.attr({
            rotation: y
        }) : i === null && (i = v(d.styles.lineHeight) *
            0.9 - d.getBBox().height / 2), m === null && (m = l.isCircular ? y > 20 && y < 160 ? "left" : y > 200 && y < 340 ? "right" : "center" : "center", d.attr({
            align: m
    ...
    h.boxplot = u(h.column, {
        ...
        drawPoints: function() {
            ...
            t(b, function(b) {
                ...
                z = b.color || a.color;
                if (b.plotY !== D)
                    if (e = b.pointAttr[b.selected ? "selected" : ""], x = A.width, s = B(A.x), w = s + x, v = E(x / 2), g = B(F ? b.q1Plot : b.lowPlot), f = B(F ? b.q3Plot : b.lowPlot), j = B(b.highPlot), n = B(b.lowPlot), k.stroke = b.stemColor || c.stemColor || z, k["stroke-width"] = r(b.stemWidth, c.stemWidth, c.lineWidth), k.dashstyle =
                        b.stemDashStyle || c.stemDashStyle, p.stroke = b.whiskerColor || c.whiskerColor || z, p["stroke-width"] = r(b.whiskerWidth, c.whiskerWidth, c.lineWidth), u.stroke = b.medianColor || c.medianColor || z, u["stroke-width"] = r(b.medianWidth, c.medianWidth, c.lineWidth), u["stroke-linecap"] = "round", i = k["stroke-width"] % 2 / 2, m = s + v + i, h = ["M", m, f, "L", m, j, "M", m, g, "L", m, n, "z"], F && (i = e["stroke-width"] % 2 / 2, m = B(m) + i, g = B(g) + i, f = B(f) + i, s += i, w += i, I = ["M", s, f, "L", s, g, "L", w, g, "L", w, f, "L", s, f, "z"]), C && (i = p["stroke-width"] % 2 / 2, j += i, n += i, o = ["M", m -
                            v * C, j, "L", m + v * C, j, "M", m - v * C, n, "L", m + v * C, n
                        ]), i = u["stroke-width"] % 2 / 2, l = E(b.medianPlot) + i, q = ["M", s, l, "L", w, l, "z"], y) b.stem.animate({
                        d: h
    ...
    L.prototype.beforePadding = function() {
        ...
        this.tickPositions && (t(this.series, function(b) {
            ...
            if (h > 0)
                for (; c--;) typeof b[c] === "number" && (l = a.radii[c], d = Math.min((b[c] - j) * k - l, d), e = Math.max((b[c] - j) * k + l, e))
        ...
        p(d, "getCoordinates", function(a, b) {
            ...
            c.polar ? t(c.axes, function(a) {
                ...
                d[e ? "xAxis" : "yAxis"].push({
                    axis: a,
                    value: a.translate(e ? Math.PI - Math.atan2(h, g) : Math.sqrt(Math.pow(h, 2) + Math.pow(g,
                        2)), !0)
                })
            }) : d = a.call(this, b);
            return d
