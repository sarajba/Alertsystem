                            ...
                            <form action="openreport.php" method="post" target="_blank">
                              ...
                              <div class="form-group">
                                ...
                                <select class="form-control" id="nodeID" name="nodeID" required="true">
                                  ...
                                  <option value="30">Node 30</option>
                                  <option value="40">Node 40</option>
                                  <option value="50">Node 50</option>
                                  <option value="60">Node 60</option>
                                  <option value="61">Node 61</option>
                                  <option value="70">Node 70</option>
                                  <option value="80">Node 80</option>
                                </select>
                              </div>
                            ...
                            <tbody>
                              ...
                              ?>
                                  <tr style="background-color:rgb(48,24,81);color:white;">
                                    <td><a style="color:white" target="_blank" href="charts_d.php?nodeID=<?php echo $row2["NodeId"] ?>"><?php echo $row2["NodeId"] ?></a></td>
                                    <td>Residence</td>
                                    <td>Up</td>
