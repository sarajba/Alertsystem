...
WHERE Date_and_time BETWEEN DATE(DATE_SUB(NOW(), INTERVAL 31 DAY)) AND DATE(NOW())
                            ...
                            <div class="col-lg-12">
                                ...
                                <script>
                                    window.onload = function chartAngle() {
                                        ...
                                        var chart = new CanvasJS.Chart("chartContainer_m", {
                                            title: {
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div id="chartContainer_m" style="height: 450px; width: 100%;"> </div>
